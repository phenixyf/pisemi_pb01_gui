...
class Pb01MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def initUI(self):
        ...
        initial_tablewidget(self.tableWidget_statusReg_pwrUpDev0, statusReg_table_headers1, HEADERHEIGHT, 150)
        set_table_item_data_and_background_color(self.tableWidget_statusReg_pwrUpDev0, 4, ROWHEIGHT,
                                                 statusReg_table_items1, [3], [])
        initial_tablewidget(self.tableWidget_statusReg_initDev0, statusReg_table_headers1, HEADERHEIGHT, 150)
        set_table_item_data_and_background_color(self.tableWidget_statusReg_initDev0, 4, ROWHEIGHT,
                                                 statusReg_table_items1, [3], [])

        initial_tablewidget(self.tableWidget_statusReg_pwrUpDev1, statusReg_table_headers2, HEADERHEIGHT, 150)
        set_table_item_data_and_background_color(self.tableWidget_statusReg_pwrUpDev1, 4, ROWHEIGHT,
                                                 statusReg_table_items2, [0], [])
        initial_tablewidget(self.tableWidget_statusReg_initDev1, statusReg_table_headers2, HEADERHEIGHT, 150)
