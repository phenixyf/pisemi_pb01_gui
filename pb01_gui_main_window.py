...
"")
        ...
        self.table_chainCfg_uartIfCfg.setRowCount(2)
        ...
        self.verticalLayout_4.addWidget(self.table_chainCfg_uartIfCfg)
        self.table_chainCfg_uartIfCfg_2 = QtWidgets.QTableWidget(self.tab_chainCfg)
        self.table_chainCfg_uartIfCfg_2.setStyleSheet("QTableWidget {\n"
"    border: 2px solid white; /* 边框颜色与粗细调整为2px */\n"
"    gridline-color: white; /* 网格线颜色 */\n"
"    background-color: #f0f0f0; /* 单元格背景颜色 */\n"
"    font-family: \"Calibri\"; /* 单元格字体 */\n"
...
"}\n"
"")
        self.table_chainCfg_uartIfCfg_2.setObjectName("table_chainCfg_uartIfCfg_2")
        self.table_chainCfg_uartIfCfg_2.setColumnCount(14)
        self.table_chainCfg_uartIfCfg_2.setRowCount(2)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(10, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(11, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(12, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setHorizontalHeaderItem(13, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setItem(0, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setItem(0, 3, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.table_chainCfg_uartIfCfg_2.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setItem(1, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_chainCfg_uartIfCfg_2.setItem(1, 3, item)
        self.table_chainCfg_uartIfCfg_2.verticalHeader().setVisible(False)
        self.verticalLayout_4.addWidget(self.table_chainCfg_uartIfCfg_2)
...
"")
        ...
        self.table_chainCfg_uartIfAddr.setRowCount(2)
        item = QtWidgets.QTableWidgetItem()
        ...
        self.verticalLayout_4.addWidget(self.table_chainCfg_uartIfAddr)
...
"")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1652, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.table_chainCfg_uartIfCfg_2.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "0"))
        item = self.table_chainCfg_uartIfCfg_2.verticalHeaderItem(1)
        item.setText(_translate("MainWindow", "1"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Address"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Register"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Expected {hex}"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Actual {hex}"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "UARTDUAL"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "UARTLPBK"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "UARTWRPATH"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "TXUIDLEHIZ"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "TXLIDLEHIZ"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "UARTDCEN"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "UARTALVCNTEN"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(11)
        item.setText(_translate("MainWindow", "{logic Zero}"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(12)
        item.setText(_translate("MainWindow", "DBLBUFEN"))
        item = self.table_chainCfg_uartIfCfg_2.horizontalHeaderItem(13)
        item.setText(_translate("MainWindow", "Reseved/SPI[6:0]"))
        __sortingEnabled = self.table_chainCfg_uartIfCfg_2.isSortingEnabled()
        self.table_chainCfg_uartIfCfg_2.setSortingEnabled(False)
        item = self.table_chainCfg_uartIfCfg_2.item(0, 0)
        item.setText(_translate("MainWindow", "0x10"))
        item = self.table_chainCfg_uartIfCfg_2.item(0, 1)
        item.setText(_translate("MainWindow", "UIFCFG (Signle AFE)"))
        item = self.table_chainCfg_uartIfCfg_2.item(0, 2)
        item.setText(_translate("MainWindow", "2600"))
        item = self.table_chainCfg_uartIfCfg_2.item(0, 3)
        item.setText(_translate("MainWindow", "A410"))
        item = self.table_chainCfg_uartIfCfg_2.item(1, 0)
        item.setText(_translate("MainWindow", "0x10"))
        item = self.table_chainCfg_uartIfCfg_2.item(1, 1)
        item.setText(_translate("MainWindow", "UIFCFG (Dual, Device 0)"))
        item = self.table_chainCfg_uartIfCfg_2.item(1, 2)
        item.setText(_translate("MainWindow", "2600"))
        item = self.table_chainCfg_uartIfCfg_2.item(1, 3)
        item.setText(_translate("MainWindow", "A410"))
        self.table_chainCfg_uartIfCfg_2.setSortingEnabled(__sortingEnabled)
