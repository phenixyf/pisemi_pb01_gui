...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_chainCfg_cfgWarn.setText(_translate("MainWindow", "WARNING:"))
        self.pushButton_chainCfg_cfg.setText(_translate("MainWindow", "CONFIGURE"))
        ...
        self.pushButton_appCfgPage_appCfgWR.setText(_translate("MainWindow", "WRITE+READ"))
        self.pushButton_appCfgPage_appCfgRd.setText(_translate("MainWindow", "READ BACK"))
        ...
        self.pushButton_appCfgPage_alertCfgWR.setText(_translate("MainWindow", "WRITE+READ"))
        self.pushButton_appCfgPage_alertCfgRd.setText(_translate("MainWindow", "READ BACK"))
        ...
        self.pushButton_appCfgPage_thresholdRegWR.setText(_translate("MainWindow", "WRITE+READ"))
        self.pushButton_appCfgPage_thresholdRegRd.setText(_translate("MainWindow", "READ BACK"))
        ...
        self.pushButton_appCfgPage_acqRegWr.setText(_translate("MainWindow", "WRITE+READ"))
        self.pushButton_appCfgPage_acqRegRd.setText(_translate("MainWindow", "READ BACK"))
        ...
        self.radioButton_acqReqPage_dataUpdate.setText(_translate("MainWindow", "Data Update Operation (0x0)"))
        self.radioButton_acqReqPage_normalMeas.setText(_translate("MainWindow", "Normal Measurement (0x1)"))
        self.radioButton_acqReqPage_redundantMeas.setText(_translate("MainWindow", "Redundant Measurement (0x2)"))
        self.radioButton_acqReqPage_pathDiag.setText(_translate("MainWindow", "PATH Diagnostic (0x3)"))
        self.radioButton_acqReqPage_balswShortDiag.setText(_translate("MainWindow", "BALSW Short Diagnostic (0x4)"))
        self.radioButton_acqReqPage_balswOpenDiag.setText(_translate("MainWindow", "BALSW Open Diagnostic (0x5)"))
        self.radioButton_acqReqPage_cellOpenDiag.setText(_translate("MainWindow", "CELL Open Diagnostic (0x6)"))
        self.radioButton_acqReqPage_busOpenDiag.setText(_translate("MainWindow", "BUS Open Diagnostic (0x7)"))
        self.radioButton_acqReqPage_cellHvmuxDiag.setText(_translate("MainWindow", "CELL HVMUX Diagnostic (0x8)"))
        self.radioButton_acqReqPage_busHvmuxDiag.setText(_translate("MainWindow", "BUS HVMUX Diagnostic (0x9)"))
        self.radioButton_acqReqPage_auxrDiag.setText(_translate("MainWindow", "AUXR Diagnostic (0xA)"))
        self.radioButton_acqReqPage_auxaDiagA.setText(_translate("MainWindow", "AUXA Diagnostic A (0xB)"))
        self.radioButton_acqReqPage_auxaDiagB.setText(_translate("MainWindow", "AUXA Diagnostic B (0xC)"))
        self.radioButton_acqReqPage_diagDataClear.setText(_translate("MainWindow", "Diagnostic Data Clear (0xE)"))
...
"For all Diagnostics, any selections above which are ignored will be automatically overridden/re-configured in the Request(s) below."))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_meaAcqSum), _translate("MainWindow", "MEAS ACQ SUM"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_meaAcqDetail), _translate("MainWindow", "MEAS ACQ DATA"))
        ...
        self.radioButton_cblPage_disable.setText(_translate("MainWindow", "Disabled/Inactive (0x0)"))
        self.radioButton_cblPage_manEven.setText(_translate("MainWindow", "Manual Even (0x1)"))
        self.radioButton_cblPage_manOdd.setText(_translate("MainWindow", "Manual Odd (0x2)"))
        self.radioButton_cblPage_semiAuto.setText(_translate("MainWindow", "Semi-Automatic (0x3)"))
        self.radioButton_cblPage_auto.setText(_translate("MainWindow", "Automatic (0x4)"))
        self.radioButton_cblPage_discharge.setText(_translate("MainWindow", "Discharge/End-of-Life (0x5)"))
        self.radioButton_cblPage_autoMeaSnd.setText(_translate("MainWindow", "Automatic Measurement by Second (0x6)"))
        self.radioButton_cblPage_autoMeaMin.setText(_translate("MainWindow", "Automatic Measurement by Minute (0x7)"))
